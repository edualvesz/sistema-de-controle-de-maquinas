            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="ip" value="{{$rede->ip}}" data-mask="00.00.00.000" class="form-control" placeholder="IP...">
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="mascara" value="{{$rede->mascara}}" data-mask="000.000.000.000" class="form-control" placeholder="Mascara...">
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="gateway" value="{{$rede->gateway}}" data-mask="00.00.00.000" class="form-control" placeholder="Gateway...">
                    </div>
                </div>
            </div>
